...
import com.tracy.test.service.BackgroundService;
import com.tracy.test.R;
import com.tracy.test.service.GrayService;
import com.tracy.test.service.WhiteService;

import static com.tracy.test.receiver.WakeReceiver.GRAY_WAKE_ACTION;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.btn_white) { //系统正常的前台Service，白色保活手段
            ...
            blackIntent.setAction(GRAY_WAKE_ACTION);
